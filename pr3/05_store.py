...
for name_staff, code_staff in goods.items():
    sum_staff = 0
    cost_staff = 0
    for position in store[code_staff]:
        sum_staff += position['quantity']
        cost_staff += position['price'] * position['quantity']
    print(name_staff, '-', sum_staff, 'шт, стоимость', cost_staff, 'руб')
